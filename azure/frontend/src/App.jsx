...
export default function App() {
  ...
  const login = () => instance.loginRedirect(loginRequest);   // B2C sign-up/sign-in user flow
  ...
  if (!isAuthed) return (
    <div className="container">
      <div className="card" style={{ maxWidth: 420, margin: '80px auto', textAlign: 'center' }}>
        ...
        <p>Sign in with your university account (Azure AD B2C).</p>
  ...
  return (
    <>
      <nav>
        ...
        {user?.system_role === 'SUPER_ADMIN' && <Link to="/admin">Admin</Link>}
